...
exports.execute = function(config){
    ...
    return xlsx.loadAsync(templateXLSX, { base64: true, checkCRC32: false }).then(function () {
        ...
        if (config.stylesXmlFile){
            ...
            var styles = null;
            return Q.nfapply(fs.readFile, [path, 'utf8']).then(function (styles) {
                if (styles){
        ...
        return xlsx.generateNodeStream({ base64: false, compression: "DEFLATE" });
